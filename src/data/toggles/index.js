...
export const nswAdminBoundariesSwitches = [
  { label: 'Local Government', icon: 'ICON', key: 'localGov' },
  { label: 'State Government', icon: 'ICON', key: 'stateGov' },
  { label: 'Federal Government', icon: 'ICON', key: 'federalGov' },
  { label: 'Suburbs', icon: 'ICON', key: 'suburbs' },
  { label: 'Parish', icon: 'ICON', key: 'Parish' },
  { label: 'NPWS Reserve', icon: 'ICON', key: 'npwsReserve' },
  { label: 'State Forest', icon: 'ICON', key: 'stateForest' },
];
